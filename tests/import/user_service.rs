use nighty_night::{
    ...
    service::user_service::{get_user_by_id_service, patch_user_service, post_new_user_service, validate_new_user_information},
};
...
pub fn test_validate_user_fields(user: NewUserDto) -> Result<(), ApiError> {
